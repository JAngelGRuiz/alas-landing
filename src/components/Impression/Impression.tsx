...
export function Impression() {
  return (
    <div className="py-6 px-3 sm:px-10">
      ...
      <article className="w-ful gap-y-10 l flex flex-col min-h-[90vh]">
        <section className="min-w-full flex flex-col items-center flex-auto">
          <div className="flex-1 flex flex-col justify-end items-center gap-y-9 sm:gap-y-4 text-center">
            ...
            <h1 className="text-lg text-gray-500 leading-tight">
            ...
            <div className="flex flex-col sm:flex-row items-center gap-3">
              ...
              <Link href="/prueba">
                <Button
                  variant="outline"
                  className="rounded-md min-h-14 px-4 py-3 text-base font-semibold max-w-xs flex items-center justify-center gap-x-4"
                >
      ...
      <section className="flex-1 w-full py-16 border-t border-gray-300 flex flex-col gap-x-5 sm:flex-row space-y-24 sm:space-y-0">
        {insights.map(({ title, description }) => (
          <article
            key={title}
            className="flex-1 flex flex-col items-center space-y-9"
          >
            <h4 className="font-semibold text-5xl">{title}</h4>
